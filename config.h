...
static const char *fonts[]                    = { "MesloLGS Nerd Font Mono:size=16:antialias=true:autohint=true:hintstyle=hintfull", "NotoColorEmoji:pixelsize=16:antialias=true:autohint=true" };
...
static Key keys[] = {
    ...
    { MODKEY,                       XK_h,                      spawn,          SHCMD ("dwm-keybinds")},
