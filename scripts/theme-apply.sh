...
# ── Locate themes.toml ────────────────────────────────────────────────────────
THEMES_FILE="${XDG_CONFIG_HOME:-$HOME/.config}/dwm-dohc/themes.toml"
...
# Change the theme in ~/.config/dwm-dohc/themes.toml instead.
...
# Ensure custom themes shipped with dwm-dohc are present
GHOSTTY_THEMES_SRC="$HOME/.local/share/dwm-dohc/ghostty/themes"
...
THEME_ENV_FILE="${XDG_CONFIG_HOME:-$HOME/.config}/dwm-dohc/theme-env.sh"
