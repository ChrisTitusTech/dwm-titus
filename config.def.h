...
/* External status bar (Polybar). Set usealtbar=0 to use dwm's built-in bar instead. */
...
/* App launcher — change to rofi if installed: { "rofi", "-show", "drun", NULL } */
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
/* Terminal — change to your preferred terminal: ghostty, alacritty, kitty, etc. */
