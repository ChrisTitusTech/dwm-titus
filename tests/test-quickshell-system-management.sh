...
grep -Fq 'parsedUpdates.length > 4096 || updateBytes > 3 * 1024 * 1024' "$model"
grep -Fq 'parsedChanges.length > 4096 || changeBytes > 3 * 1024 * 1024' "$model"
...
grep -Fq 'requestedCount === 0 || planRequiresUnsupportedFlags' "$model"
