...
Panel-widget persistence is also merged. The remaining Phase 5 surface begins
with combined optional-component qualification, followed by notifications,
practical X11 accessibility controls, selected UI-5 work, and final phase
qualification. The ordered status is recorded in `ROADMAP.md`, `TASKS.md`, and
`docs/P5-STATUS.md`.
